![](https://img.shields.io/badge/comment-disqus-orange)![](https://img.shields.io/github/languages/count/oragekk/oragekk.github.io?color=green)

# Hux blog 模板

### 此博客引用自 Hux blog 以下是此模板的配置方式【引用自Hux blog】


### [我的博客在这里 &rarr;](http://oragekk.me)
